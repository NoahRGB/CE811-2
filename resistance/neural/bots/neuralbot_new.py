...
model = keras.models.load_model("neural/trainers/loggerbot_classifier2.keras")
    ...
    def calc_player_probabilities_of_being_spy(self):
        ...
        for p in self.game.players:
            ...
            input_vector = [self.game.turn, self.game.tries, p.index, p.name, self.missions_been_on[p],
                            self.failed_missions_been_on[p], self.upvoted_missions_they_are_on[p]] + self.num_missions_voted_up_with_total_suspect_count[p] + \
