...
def negamax_prune(board, current_depth, max_depth, player, alpha, beta):
    ...
    for move in valid_moves:
        ...
        new_move, new_val = negamax_prune(board.play(move), current_depth+1, max_depth, player, -beta, -max(alpha, best_val))
